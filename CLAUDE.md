...
| KLUE-RoBERTa-large 대조군(512 창·절단 규칙·크기 confound)       | `docs/experiments/klue-roberta.md`          |
| 무훈련 분석 3종(오류 분해·임계값 튜닝 계획 / 토크나이저 분석 실측·로짓 재확보)       | `docs/experiments/no-train-analysis.md`     |
