...
- **−2.39pt는 τ=0.5 전역 micro 한정 진술이다.** 표적 슬라이스 k≥2 micro는 ASL 0.8046으로 네 손실 중 최고이며 exp1(len8192, 0.8048)과 사실상 동률이다. ASL의 열위는 학습 실패가 아니라 손실이 의도적으로 이동시킨 operating point의 결과다.
